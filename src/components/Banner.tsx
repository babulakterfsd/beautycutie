  ...
  return (
    <section className={`${Styles.bannerBg}`}>
      <div className="main-container">
        <div
          className="flex flex-row justify-center lg:pl-20 mb-4 lg:mb-6"
          data-aos="fade-down"
        ...
        <div
          className="lg:w-[838px] lg:mx-auto"
          data-aos="fade-up"
          data-aos-duration="1500"
        >
        ...
        <div
          className="mt-8 lg:mt-12 flex justify-center flex-col md:flex-row gap-y-3 md:gap-x-6"
          data-aos="fade-up"
          data-aos-duration="1500"
        >
        ...
        <div
          className="mt-28 mb-32 lg:mb-0 lg:mt-32 z-50 p-3 pb-0 md:p-5 md:pb-0 lg:p-8 lg:pb-0 gradientBg rounded-t-3xl"
          data-aos="fade-up"
          data-aos-duration="1500"
        >
          <Image
