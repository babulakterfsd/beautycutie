...
const BlogPost = () => {
  ...
  return (
    <div className="dashboard-container flex flex-col md:flex-row   gap-x-[10px] h-screen md:mt-3 md:ml-3 w-full relative">
      <div className="dashboard-content w-full order-2 md:order-1  md:p-5 rounded-md h-screen overflow-y-scroll overflow-x-scroll md:overflow-x-hidden scrollbar-thumb-gray-400 scrollbar-track-gray-200 md:w-4/6   ">
        <div className=" w-full md:px-6 px-3  shadow-xl">
          <h1 className="mt-3 md:mt-0 text-[#67748E] text-[14px] leading-[18px] md:text-[18px] md:leading-[28px] font-semibold mb-2">
            Blog post
          </h1>
          <BlogForm />
          <CustomSelect
          ...
          />
          <div className="blog-submit-btn md:flex gap-y-3 md:gap-y-0 flex-col md:flex-row justify-between md:gap-x-2">
            <Button
