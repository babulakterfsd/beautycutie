...
const Messages: React.FC<{ messages: Message[] }> = ({ messages }) => {
  ...
  return (
    <div className="dashboard-container w-screen flex flex-col gap-y-8 md:flex-row gap-x-[20px] lg:h-screen md:mt-3 md:ml-3 mb-6">
      <div className="dashboard-content order-2 lg:order-1  mx-auto  w-full  md:w-8/12 shadow-lg rounded-md h-screen overflow-y-scroll overflow-x-scroll  scrollbar-thumb-gray-400 scrollbar-track-gray-200 border-2 border-gray-100">
