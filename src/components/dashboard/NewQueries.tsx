          ...
          <div className="w-full p-3  md:mt-[32px] px-4">
            <div className="flex justify-between items-center">
              ...
              <div className="flex bg-[#F9F5FF] px-4 py-1 rounded-3xl items-center gap-x-1">
                <p className="   text-[#FFAAA5] px-1 text-[12px] md:text-[14px] font-medium leading-[18px] md:leading-[20px] py-0.5 rounded-3xl ">
                  After sale
                </p>
              </div>
            </div>
            <h3 className=" text-[#67748E] md:mt-[8px] text-[12px] md:text-[16px] font-bold lg:font-semibold leading-[18px] md:leading-[24px]  ">
              {timeString}
            </h3>
            <p className="mt-2 md:mt-4 text-[#67748E] text-[14px] md:text-[16px] leading-[24px]">
              How to access this feature
            </p>
          </div>
        </div>
